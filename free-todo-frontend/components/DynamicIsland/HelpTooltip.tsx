          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">灵动岛操作说明</h3>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="space-y-4 text-sm text-white/80">
                <div>
                  ...
                  <ul className="space-y-1 text-white/60 ml-4">
                    <li>• 按 <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">1</kbd> - 悬浮窗模式</li>
                    <li>• 按 <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">2</kbd> - 弹窗模式</li>
                    <li>• 按 <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">3</kbd> - 侧边栏模式</li>
                    <li>• 按 <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">4</kbd> - 全屏模式</li>
                    <li>• 按 <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">Esc</kbd> - 退出当前模式</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-white/60 ml-4">
                    <li>• <strong>点击</strong> - 开始/暂停/恢复录音</li>
                    <li>• <strong>右键</strong> - 停止录音并保存</li>
                    <li>• 录音状态与页面完全同步</li>
                    <li>• 支持实时转录和智能提取</li>
                  </ul>
                </div>
