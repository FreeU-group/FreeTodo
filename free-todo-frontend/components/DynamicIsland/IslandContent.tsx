...
export const FloatContent: React.FC<{
	...
	return (
		<motion.div
			...
			style={{ WebkitAppRegion: "no-drag" } as React.CSSProperties} // 按钮区域不允许拖拽
		>
			{/* Left: Recording Status - UI 仅显示，功能已移除 */}
			<div
				className="flex items-center justify-center flex-shrink-0 opacity-50"
				title="录音功能已禁用"
			>
