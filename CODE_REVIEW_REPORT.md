...
> 审查日期：2026-03-15  
> 覆盖范围：server（Python后端）、frontend（TypeScript/React前端）、client（Python感知客户端）、cli、phone（Flutter移动端）、src-tauri（Rust桌面端）、deploy  
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/preview.py` 第 17-28 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/plugin_manager.py` 第 245-246 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/automation_task_service.py` 第 218-220 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/schemas/agent_plan.py` 第 70-71 / 95-96 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/llm_client_vision.py` 第 91 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/rag_service.py` 第 165-167 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/database_base.py` 第 246 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/agent_plan_manager.py` 第 163-178 / 276-291 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/breakdown-store.ts` 第 142-194 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/breakdown-store.ts` 第 192-194 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/breakdown-store.ts` 第 150-183 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/audio-recording-store.ts` 第 492-600 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/capture_provider.dart` 第 197 行 vs 第 1012-1015 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/capture_provider.dart` 第 66/1526/1533/1609 行 |
...
|------|------|
| **模块** | src-tauri |
| **文件** | `frontend/src-tauri/src/backend.rs` 第 474-477/499-502 行；`nextjs.rs` 第 281-284 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/config.py` 第 162/175 行；`server/llm/llm_client.py` 第 93-96 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/todo.py` 第 124-133 行；`server/llm/agno_agent.py` 第 414-437 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/sensor_control.py` 第 25-26/42-49 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/llm_client_intent.py` 第 46 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/util/settings.py` 第 94/132 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/audio_extraction_service.py` 第 442-452 行；`server/services/audio_extraction/gate.py` 第 129-137 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/icalendar_service.py` 第 252-265 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/icalendar_service.py` 第 130-131 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/config_service.py` 第 393 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/stats_manager.py` 第 53-86 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/notification_storage.py` 第 12-15 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/event_manager.py` 第 82-145 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/todo_manager.py` 第 188/216/255 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/ocr_todo_extractor.py` 第 72-78 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/config.py` 第 531-532 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/plan.ts` 第 46-89/94-134 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/plan.ts` 第 75-88/120-133 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | 所有 `frontend/lib/generated/*/*.ts` + `frontend/lib/api/fetcher.ts` |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/plan.ts` 第 67-69/112-113 行 |
...
|------|------|
| **模块** | client |
| **文件** | `client/proactive_ocr/capture.py` 第 311-352 行 |
...
|------|------|
| **模块** | client |
| **文件** | `client/proactive_ocr/capture.py` 第 336 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/device_provider.dart` 第 285-287 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/capture_provider.dart` 第 1002-1018 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/message_provider.dart` 第 362-367 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/backend/http/shared.dart` 第 25-52 行 |
...
|------|------|
| **模块** | src-tauri |
| **文件** | `frontend/src-tauri/src/backend_proxy.rs` 第 86/98 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/capture_provider.dart` 第 1952-1966 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/agent_plan.py` 第 115-130 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/chat_service.py` 第 89-114 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/todo_service.py` 第 171/181 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/config_service.py` 第 396-402 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/config_service.py` 第 386-406 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/journal_service.py` 第 222 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/plugin_manager.py` 第 48-49/192-194 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/diary_illustration_service.py` 第 177-179 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/audio_service.py` 第 121-139 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/services/audio_service.py` 第 151-152 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/todo.py` 第 41 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/todo.py` 第 202-218 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/perception_ws.py` 第 100-101 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/screenshot.py` 第 128-132 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/event.py` 第 28-29 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/routers/logs.py:52` 等多处 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/llm_client.py` 第 72 行 vs `server/util/settings.py` 第 145 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/llm_client_query.py` 第 222 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/llm/todo_extraction_service.py` 第 276 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/util/logging_config.py` 第 118/129 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/schemas/search.py` 第 13 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/util/agent_os_utils.py` 第 13-15 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/event_manager.py` 第 178 行；`server/storage/activity_manager.py` 第 65 行 |
...
|------|------|
| **模块** | server |
| **文件** | `server/storage/todo_manager_ical.py` 第 155-157 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/apps/chat/hooks/useSendMessage.ts` 第 412-443 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/electron/island-window-manager.ts` 第 241-267 vs 492-498 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/components/island/DynamicIsland.tsx` 第 192-194 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/hooks/usePanelWindowStyles.ts` 第 19-49 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/audio-recording-store.ts` 第 708-744 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/audio-recording-store.ts` 第 607-623 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/breakdown-store.ts` 第 61-72 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/generated/case-transform.ts` 第 22-28 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/fetcher.ts` 第 14-17 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/fetcher.ts` 第 202-211 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/store/notification-store.ts` 第 156-186 行 |
...
|------|------|
| **模块** | client |
| **文件** | `client/proactive_ocr/ocr_engine_winrt.py` 第 134-139 行 |
...
|------|------|
| **模块** | client |
| **文件** | `client/proactive_ocr/priors/feishu.py` 第 51-54 行 |
...
|------|------|
| **模块** | client |
| **文件** | `client/proactive_ocr/capture.py` 第 92-97 行；`client/sensor.py` 第 97-103 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/home_provider.dart` 第 220-222 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/device_provider.dart` 第 153-162 行 |
...
|------|------|
| **模块** | src-tauri |
| **文件** | `frontend/src-tauri/src/backend.rs` 第 199/442/471/494 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/conversation_provider.dart` 第 516-521 行 |
...
|------|------|
| **模块** | src-tauri |
| **文件** | `frontend/src-tauri/src/nextjs.rs` 第 84-96 行 |
...
|------|------|
| **模块** | phone |
| **文件** | `phone/lib/providers/capture_provider.dart` 第 44-45 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/lib/api/fetcher.ts` 第 176-178 行 |
...
|------|------|
| **模块** | frontend |
| **文件** | `frontend/electron/main.ts` 第 108-114 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/notification.py` 第 55-56 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/todo.py` 第 217-218 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/automation.py` 第 18/28/37 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/automation.py` 第 66-71 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/location.py` 第 26-34 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/routers/cost_tracking.py` 第 38 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/services/dify_client.py` 第 35-43 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/services/automation_task_service.py` 第 246 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/services/asr_client.py` 第 28-38 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/schemas/todo.py` 第 190-191 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/schemas/chat.py` 第 67-68 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/schemas/floating_capture.py:18` vs `server/schemas/todo_extraction.py:30` |
...
| 模块 | 文件 |
|------|------|
| server | `server/util/settings.py` 第 143/150/155/159 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/storage/event_queries.py` 第 37/87 行 |
...
| 模块 | 文件 |
|------|------|
| server | `server/storage/chat_manager.py` 第 327-342 行；`server/storage/event_queries.py` 第 43-52 行 |
...
| 模块 | 文件 |
|------|------|
| frontend | `frontend/lib/store/todo-intent-stream-store.ts`、`perception-stream-store.ts` |
...
| 模块 | 文件 |
|------|------|
| frontend | `frontend/lib/store/todo-store.ts` 第 134-137 行 |
...
| 模块 | 文件 |
|------|------|
| frontend | `frontend/components/island/DynamicIsland.tsx` 第 228-232 行 |
...
| 模块 | 文件 |
|------|------|
| frontend | `frontend/lib/hooks/useOnboardingTour.ts` 第 75-84 行 |
...
| 模块 | 文件 |
|------|------|
| frontend | `frontend/electron/ipc-handlers.ts` 第 85-92 行 |
...
| 模块 | 文件 |
|------|------|
| client | `client/sensor.py` 第 62-66 行 |
...
| 模块 | 文件 |
|------|------|
| client | `client/proactive_ocr/ocr_engine.py` 第 161-168 行 |
...
| 模块 | 文件 |
|------|------|
| client | `client/util/time_utils.py` 第 8 行 |
...
| 模块 | 文件 |
|------|------|
| client | `client/proactive_ocr/__init__.py` |
...
| 模块 | 文件 |
|------|------|
| phone | `phone/lib/providers/message_provider.dart` 第 981-986 行 |
...
| 模块 | 文件 |
|------|------|
| phone | `phone/lib/backend/http/shared.dart` 第 77-82 行 |
...
| 模块 | 文件 |
|------|------|
| src-tauri | `frontend/src-tauri/src/lib.rs` 第 162-168 行 |
...
| 模块 | 文件 |
|------|------|
| phone | `phone/lib/services/sockets/transcription_service.dart` 第 143-150 行 |
...
| 模块 | 文件 |
|------|------|
| src-tauri | `frontend/src-tauri/src/backend.rs` 第 512 行；`nextjs.rs` 第 293 行 |
...
|------|----------|------|--------|-----|------|
| **server** | 9 | 17 | 25 | 16 | 67 |
| **frontend** | 4 | 4 | 13 | 8 | 29 |
| **client/cli** | 2 | 3 | 5 | 6 | 16 |
| **phone/tauri** | 3 | 5 | 7 | 5 | 20 |
| **合计** | **18** | **29** | **50** | **35** | **132** |
