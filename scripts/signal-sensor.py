...
def main() -> None:
    ...
    parser.add_argument(
        "--center-url", default="", help="Center node URL for remote notification polling"
    )
    parser.add_argument("--node-id", default=platform.node(), help="Node ID (defaults to hostname)")
