...
from repositories.interfaces import IEventRepository, IOcrRepository
from schemas.event import EventDetailResponse, EventListResponse, EventResponse
...
class EventService:
    ...
    def generate_event_summary(self, event_id: int) -> dict[str, Any]:
        ...
        # 延迟导入避免循环依赖
        summary_module = importlib.import_module("llm.event_summary_service")
