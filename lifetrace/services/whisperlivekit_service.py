            ...
            while waited < max_wait:
                ...
                if self.server_process.poll() is not None:
                    ...
                    try:
                        ...
                        logger.error(f"WhisperLiveKit 服务器启动失败:\nstdout: {stdout}\nstderr: {stderr}")
                ...
                try:
                    ...
                    sock.close()
                    if result == 0:
                        logger.info(f"✅ WhisperLiveKit 服务器已启动 (端口: {self.server_port})，耗时: {waited:.1f} 秒")
...
# 全局服务实例
_whisperlivekit_service: Optional[WhisperLiveKitService] = None
