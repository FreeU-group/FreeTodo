...
function setBusy(busy){state.isStreaming=busy;document.getElementById('sendBtn').disabled=busy;document.getElementById('chatInput').disabled=busy;document.getElementById('confirmBtn').disabled=busy;document.getElementById('dismissBtn').disabled=busy;document.getElementById('confirmExecuteBtn').disabled=busy}
