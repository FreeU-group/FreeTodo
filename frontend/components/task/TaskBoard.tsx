						...
						{isAddingTask ? (
							<div className="flex gap-2">
								<input
									...
									placeholder={
										t.projectDetail.taskNamePlaceholder || "输入任务名称..."
									}
		...
		>
			...
			<div className="absolute top-2 left-2 right-2 flex items-center justify-between z-10">
				...
				<button
					...
					title={
						isSelected
							? t.projectDetail.unselectTask
							: t.projectDetail.selectTask
					}
				>
			...
			{/* 任务内容 - 点击跳转到详情 */}
			<div className="p-3 pt-8 cursor-pointer" onClick={handleCardClick}>
