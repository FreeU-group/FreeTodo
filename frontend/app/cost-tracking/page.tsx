...
export default function CostTrackingPage() {
	...
	const getFeatureName = (featureId: string) => {
		return (
			t.costTracking.featureNames[
				featureId as keyof typeof t.costTracking.featureNames
			] || featureId
		);
	};
			...
			<div className="mb-6 flex items-center gap-4">
				<div className="flex items-center gap-2">
					...
					<span className="text-sm text-gray-600 dark:text-gray-400">
						{t.costTracking.statisticsPeriod}:
					</span>
				</div>
				<select
					value={days}
			...
			{loading ? (
				...
				<>
					...
					<div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 mb-6">
						<div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
							<h2 className="text-xl font-semibold">
								{t.costTracking.featureCostDetails}
							</h2>
						</div>
					...
					<div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 mb-6">
						<div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
							<h2 className="text-xl font-semibold">
								{t.costTracking.modelCostDetails}
							</h2>
						</div>
						<div className="overflow-x-auto">
							<table className="w-full">
